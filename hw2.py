...
#1. возвести каждый 4-й элемент в квадрат

a = [4, 6, 5, 9, 88, 11, 35, 79, 168, 11, ...] # 16 элементов
...
#2. реализовать функцию, которая по букве увеличивает ее в строке и отдает новую строку
